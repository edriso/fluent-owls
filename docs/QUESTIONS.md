...
The project ships with about a dozen questions per level. Add more whenever you have a good idea. There is no upper bound, and the cycle lengthens on its own.
