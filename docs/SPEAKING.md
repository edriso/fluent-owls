...
(192), 22 grammar points per level (132, the daily grammar slot, about 4.5
months), and 20 phrases per level (120). Monologues (22 per level, 132) and
question prompts (26 per level, 156) are on-demand only. Add more to lengthen any
cycle.
...
bank (936 voice clips) is around 86k credits to generate once, well within a
