 ...
 *
 * The set is a full daily loop: the quizzes build the words that make you
 * correct; the phrase gives a ready-made chunk; the dialogue trains real
 * back-and-forth conversation; the shadowing clip drills rhythm and accent. The
 * quizzes plus the three speaking exercises cover both halves of "good English":
 * being correct and being well spoken.
 *
