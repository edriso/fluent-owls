...
export const c1Questions: QuizQuestion[] = [
  ...
  },
  {
    ...
    options: ['inflicted', 'made', 'did', 'gave'],
    correctIndex: 0,
  ...
  },
  {
    ...
    options: ['discretion', 'discreet', 'discrete', 'discreetly'],
    correctIndex: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['mixed', 'double', 'half', 'full'],
    correctIndex: 0,
  ...
  },
  {
    ...
    options: ['prohibited', 'inhibited', 'exhibited', 'inhabited'],
    correctIndex: 0,
  ...
  },
  {
    ...
    options: ['gloss', 'glance', 'glide', 'glow'],
    correctIndex: 0,
